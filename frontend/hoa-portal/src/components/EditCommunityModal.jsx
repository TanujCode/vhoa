...
const EditCommunityModal = ({ isOpen, onClose, community, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[100]">
      <div className="bg-white dark:bg-gradient-to-br dark:from-[#1E2E42] dark:to-[#162535] border border-slate-200/80 dark:border-white/10 rounded-3xl w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto custom-scrollbar text-slate-900 dark:text-white">
