            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              <div className="lg:col-span-5 space-y-6 text-left">
                ...
                <div className="pt-4 flex gap-3">
                  <Link to="/rental/register" className="flex-1 py-3 bg-gradient-to-r from-violet-500 to-indigo-600 hover:from-violet-600 hover:to-indigo-700 text-white font-bold text-xs uppercase tracking-wider rounded-xl text-center shadow-md active:scale-95 transition-all">
                    Start Free Trial
                  </Link>
