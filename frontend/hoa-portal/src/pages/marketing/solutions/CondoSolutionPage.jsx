      ...
      <div className="flex-1 overflow-x-hidden">
        ...
        <section className="py-24 border-t border-slate-200/40 dark:border-white/[0.04] relative">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-4 gap-6 px-5">
            {/* Stripe */}
            <div className="p-6 rounded-2xl border border-slate-200/80 dark:border-white/[0.07] bg-white/40 dark:bg-white/[0.02] backdrop-blur-md text-left space-y-2 hover:shadow-lg hover:border-violet-500/20 transition-all duration-300">
              ...
              <p className="text-[11px] text-slate-450 dark:text-slate-400 leading-normal font-display">Handle amenity reservation deposits and hourly block tariffs.</p>
            </div>
            {/* Plaid */}
            <div className="p-6 rounded-2xl border border-slate-200/80 dark:border-white/[0.07] bg-white/40 dark:bg-white/[0.02] backdrop-blur-md text-left space-y-2 hover:shadow-lg hover:border-violet-500/20 transition-all duration-300">
              ...
              <p className="text-[11px] text-slate-450 dark:text-slate-400 leading-normal font-display">Verify resident accounts to confirm payment profiles instantly.</p>
            </div>
            {/* Twilio */}
            <div className="p-6 rounded-2xl border border-slate-200/80 dark:border-white/[0.07] bg-white/40 dark:bg-white/[0.02] backdrop-blur-md text-left space-y-2 hover:shadow-lg hover:border-violet-500/20 transition-all duration-300">
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">03 / GATE CODES</span>
              <h4 className="text-sm font-black text-slate-900 dark:text-white">Twilio API</h4>
              <p className="text-[11px] text-slate-450 dark:text-slate-400 leading-normal font-display">Auto-dispatch temporary entry gate OTP passcodes to guest cellphones.</p>
            </div>
            {/* SMTP */}
            <div className="p-6 rounded-2xl border border-slate-200/80 dark:border-white/[0.07] bg-white/40 dark:bg-white/[0.02] backdrop-blur-md text-left space-y-2 hover:shadow-lg hover:border-violet-500/20 transition-all duration-300">
              ...
              <p className="text-[11px] text-slate-450 dark:text-slate-400 leading-normal font-display">Send hourly slot reservations and cleanup reminders instantly.</p>
            </div>
          </div>
        </section>
