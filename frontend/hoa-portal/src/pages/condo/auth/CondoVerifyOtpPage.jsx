...
const CondoVerifyOtpPage = () => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      await API.post('/condo/auth/otp/verify', {
        email_id: email,
        otp_code: otp,
        purpose: 'REGISTER'
      });
      ...
      setTimeout(() => navigate('/condo/login'), 2500);
  ...
  const handleResendOtp = async () => {
    ...
    setSuccessMsg('');
    try {
      await API.post('/condo/auth/otp/send', { email_id: email }); 
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 font-sans">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-gray-900">Verify Your Condo Email</h2>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            ...
            <button 
              ...
              disabled={loading}
              className="ml-2 text-blue-600 hover:text-blue-800 font-bold transition-colors disabled:text-gray-400 bg-transparent border-none outline-none cursor-pointer"
            >
              Resend OTP
            </button>
          </p>
...
export default CondoVerifyOtpPage;
