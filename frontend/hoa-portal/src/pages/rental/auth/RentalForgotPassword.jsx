...
const RentalForgotPassword = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      setTimeout(() => navigate('/rental/login'), 2000);
    } catch (err) {
  ...
  return (
    <AuthLayout>
      <div className="max-w-md mx-auto">
        <div className="mb-8">
          <Link to="/rental/login" className="inline-flex items-center text-[#0F2D59] hover:underline mb-4 text-sm font-medium">
...
export default RentalForgotPassword;
