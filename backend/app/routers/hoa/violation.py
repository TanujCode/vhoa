...
from app.models.hoa.violation import ViolationStatus
...
from app.services.hoa.violation_service import (
...
def update_type(
    ...
    from app.models.hoa.violation import ViolationType
...
def create(
    ...
    try:
        from app.services.hoa.email_service import send_violation_email
        from app.models.hoa.user import User
...
def update_status(
    ...
    from app.models.hoa.violation import Violation
