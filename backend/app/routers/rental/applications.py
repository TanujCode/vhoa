...
def review_application(
    ...
    try:
        ...
        log_action(db, "REVIEW_APPLICATION", "rental", f"Application {application_id} marked as {status_str}.", current_user.user_id)
        return app
...
def delete_application(
    ...
    try:
        ...
        log_action(db, "DELETE_APPLICATION", "rental", f"Application {application_id} deleted.", current_user.user_id)
