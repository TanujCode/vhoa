...
copy_dirs = [
    ...
    (r"backend\app\models\rental", r"backend\app\models\rental"),
    (r"backend\app\routers\rental", r"backend\app\routers\rental"),
    (r"backend\app\services\rental", r"backend\app\services\rental"),
]

# Copy specific old files as per copy_to_git.bat
old_targets = [
    (r"backend\app\models\__init__.py", r"backend\app\models\__init__.py"),
    (r"backend\app\models\hoa\user.py", r"backend\app\models\hoa\user.py"),
    ...
    (r"backend\app\routers\hoa\service_request.py", r"backend\app\routers\hoa\service_request.py"),
    (r"backend\app\routers\hoa\payment.py", r"backend\app\routers\hoa\payment.py"),
    (r"backend\app\routers\hoa\user.py", r"backend\app\routers\hoa\user.py"),
    (r"backend\app\main.py", r"backend\app\main.py"),
    (r"backend\app\routers\hoa\amenity.py", r"backend\app\routers\hoa\amenity.py"),
    (r"backend\app\services\hoa\amenity_service.py", r"backend\app\services\hoa\amenity_service.py"),
    (r"backend\app\services\hoa\violation_service.py", r"backend\app\services\hoa\violation_service.py"),
    (r"backend\app\services\hoa\service_request_service.py", r"backend\app\services\hoa\service_request_service.py"),
    (r"backend\app\services\hoa\location_service.py", r"backend\app\services\hoa\location_service.py"),
    (r"backend\app\services\hoa\payment_service.py", r"backend\app\services\hoa\payment_service.py"),
    ...
    (r"backend\app\services\hoa\auth_service.py", r"backend\app\services\hoa\auth_service.py"),
    (r"backend\app\routers\hoa\auth.py", r"backend\app\routers\hoa\auth.py"),
    ...
    (r"backend\app\models\hoa\meeting_survey.py", r"backend\app\models\hoa\meeting_survey.py"),
    (r"backend\app\schemas\meeting_survey.py", r"backend\app\schemas\meeting_survey.py"),
    (r"backend\app\schemas\rental.py", r"backend\app\schemas\rental.py"),
    (r"backend\app\routers\hoa\meeting_survey.py", r"backend\app\routers\hoa\meeting_survey.py"),
    (r"frontend\hoa-portal\src\services\meetingSurveyService.js", r"frontend\hoa-portal\src\services\meetingSurveyService.js"),
    (r"backend\app\services\hoa\meeting_survey_service.py", r"backend\app\services\hoa\meeting_survey_service.py"),
    (r"backend\app\routers\hoa\vendor.py", r"backend\app\routers\hoa\vendor.py"),
    (r"backend\app\schemas\community.py", r"backend\app\schemas\community.py"),
    (r"backend\app\services\hoa\community_service.py", r"backend\app\services\hoa\community_service.py"),
    (r"frontend\hoa-portal\src\components\AiAssistant.jsx", r"frontend\hoa-portal\src\components\AiAssistant.jsx"),
    (r"backend\app\routers\hoa\community.py", r"backend\app\routers\hoa\community.py"),
    (r"backend\app\routers\hoa\contract.py", r"backend\app\routers\hoa\contract.py"),
    (r"backend\requirements.txt", r"backend\requirements.txt"),
    (r"backend\app\routers\hoa\report.py", r"backend\app\routers\hoa\report.py"),
    (r"frontend\hoa-portal\src\pages\Dashboard.jsx", r"frontend\hoa-portal\src\pages\Dashboard.jsx"),
    (r"backend\app\routers\hoa\location.py", r"backend\app\routers\hoa\location.py"),
    (r"frontend\hoa-portal\src\components\AddCommunityModal.jsx", r"frontend\hoa-portal\src\components\AddCommunityModal.jsx"),
    (r"backend\app\services\hoa\email_service.py", r"backend\app\services\hoa\email_service.py"),
    (r"backend\app\routers\hoa\violation.py", r"backend\app\routers\hoa\violation.py"),
